...
video_directory = "D:\\Python\\paletizadora\\videos\\croppeds\\8_1.mp4"
cap = cv2.VideoCapture(video_directory)

# Define the codec and create VideoWriter object
fourcc = cv2.VideoWriter_fourcc(*'XVID')
out = cv2.VideoWriter('output3.avi', fourcc, 20.0, (1200, 800))  # Adjust the FPS and resolution as needed
...
while True:
    ...
    if frame_count % 2 == 0:  # Process every 4th frame (i.e., skip 3 frames)
        ...
        img = cv2.resize(img, (1200, 800))  # Adjust the resolution as needed
        out.write(img)  # Write the frame into the file
